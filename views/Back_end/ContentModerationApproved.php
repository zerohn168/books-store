<div class="container-fluid mt-4">
    <div class="row mb-4">
        <div class="col-md-6">
            <h2><i class="bi bi-check-circle"></i> Đánh Giá Đã Duyệt</h2>
    ...
    <div class="alert alert-info">
        <i class="bi bi-info-circle"></i> Không có đánh giá nào đã được duyệt
    </div>
    <?php else: ?>
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <small><?= $review['moderated_by'] ? 'Admin #' . $review['moderated_by'] : 'Tự động' ?></small>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
