...
<html lang="en">
    ...
    <body>
        ...
        $orderId = isset($_SESSION['payment_info']['order_database_id']) ? $_SESSION['payment_info']['order_database_id'] : null;
        $vnp_TxnRef = isset($_SESSION['payment_info']['order_id']) ? $_SESSION['payment_info']['order_id'] : '';
        $vnp_ResponseCode = isset($_SESSION['payment_info']['response_code']) ? $_SESSION['payment_info']['response_code'] : '';
        ?>
        <div class="container">
            <div class="card">
                <div class="card-header">
                    <h3 class="text-center mb-0">Kết quả thanh toán VNPAY</h3>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <div class="form-group">
                            ...
                            <span><?php echo htmlspecialchars($payment_info['order_id']); ?></span>
                        </div>    
                        <div class="form-group">
                            <label>Số tiền:</label>
                        ...
                        <div class="form-group">
                            ...
                            <span><?php echo htmlspecialchars($payment_info['order_info']); ?></span>
                        </div> 
                        <div class="form-group">
                            <label>Mã GD Tại VNPAY:</label>
                            <span><?php echo htmlspecialchars($payment_info['transaction_no']); ?></span>
                        </div> 
                        <div class="form-group">
                            <label>Mã Ngân hàng:</label>
                            <span><?php echo htmlspecialchars($payment_info['bank_code']); ?></span>
                        </div> 
                        <div class="form-group">
                        ...
                        <div class="result-box <?php echo ($vnp_ResponseCode == '00' || (isset($_SESSION['payment_success']) && $_SESSION['payment_success'])) ? 'success' : 'error' ?>">
                            ...
                            if ($vnp_ResponseCode == '00' || (isset($_SESSION['payment_success']) && $_SESSION['payment_success'])) {
                                ...
                                echo "<p>Mã đơn hàng của bạn là: <strong>" . htmlspecialchars($vnp_TxnRef) . "</strong></p>";
                                echo "<p>Số tiền đã thanh toán: <strong>" . number_format($vnp_Amount/100, 0, ',', '.') . " VNĐ</strong></p>";
                                if ($vnp_TransactionNo) {
                                    echo "<p>Mã giao dịch VNPAY: <strong>" . htmlspecialchars($vnp_TransactionNo) . "</strong></p>";
                                }
                                echo "</div>";
                            } else {
                                echo "<div class='text-center'>";
                                if ($vnp_ResponseCode == '24') {
                                    ...
                                    if ($vnp_ResponseCode) {
                                        echo "<p>Mã lỗi: " . htmlspecialchars($vnp_ResponseCode) . "</p>";
                                    }
                    ...
                    if (($vnp_ResponseCode == '00' || (isset($_SESSION['payment_success']) && $_SESSION['payment_success'])) && $vnp_TxnRef) {
                        try {
                            ...
                            echo '<strong>Thông báo:</strong> Không thể tải chi tiết hóa đơn. Vui lòng xem lịch sử đơn hàng để xem chi tiết.';
                            echo '</div>';
                        }
                    }
                    ?>
